        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ManagementId = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: false),
                    ChangeField = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false),
            ...
            migrationBuilder.CreateIndex(
                ...
                columns: new[] { "ManagementId", "HistoryId" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_Devices_ManagementId",
                table: "Devices",
                column: "ManagementId",
                unique: true);
        }
